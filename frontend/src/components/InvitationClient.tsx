...
const InvitationClient: React.FC<InvitationClientProps> = ({ event, invitation_img, music, guestInvite }) => {
    ...
    return (
        <div className="bg-[#FAF9F6] min-h-screen relative selection:bg-amber-100 italic-fonts">
            {/* Action Buttons - Floating at the top for mobile */}
            <div className="fixed top-4 left-0 right-0 z-40 px-4 pointer-events-none">
            ...
            <div className="h-20 sm:hidden"></div> {/* Spacer for fixed top buttons */}
