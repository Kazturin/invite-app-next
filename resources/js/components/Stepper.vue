  ...
  <div class="wrapper-steppy" :style="cssVars">
    <div class="steppy">
      ...
      >
        ...
        <span class="steppy-item-title max-w-[120px] text-xs sm:text-sm">{{ item['title_'+$i18n.locale] }}</span>
      </div>
    </div>
...
const emit = defineEmits(["update:step","incrementStep","decrementStep"]);
